...
# random_fortest Model
random_forest = RandomForestClassifier()
random_forest.fit(X_train_array, y_train)

#Prediction
y_pred_train_rf = random_forest.predict(X_train_array)
y_pred_test_rf = random_forest.predict(X_test_array)
...
joblib.dump(random_forest, os.path.join(folder_path, 'random_forest_model.pkl'))
