...
#Prediction
y_pred_train_nb = naive_bayes.predict(X_train_array)
y_pred_test_nb = naive_bayes.predict(X_test_array)
...
joblib.dump(naive_bayes, os.path.join(folder_path, 'naive_bayes_model.pkl'))
